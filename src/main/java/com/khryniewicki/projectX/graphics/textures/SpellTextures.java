...
public class SpellTextures {
    ...
    public static final Texture FIREICONFADED= new Texture("ultimateFireIconFaded.png");

    public static final Texture FIREBALL= new Texture("fireball.png");
    ...
    public static final Texture ICEBALL_UP = new Texture("iceballUp.png");
    ...
    public static final Texture VIOLETICONFADED= new Texture("thunderIconFaded.png");
    ...
    public static final Texture BLACKFIREICONFADED = new Texture("blackFireIconFaded2.png");
    ...
    public static final Texture BLUEICONFADED= new Texture("blueIconFaded.png");

    public static final Texture BLOODORB= new Texture("bloodOrb.png");
