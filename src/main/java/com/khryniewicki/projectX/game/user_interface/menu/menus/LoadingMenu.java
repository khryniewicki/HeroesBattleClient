...
import static com.khryniewicki.projectX.game.user_interface.menu.graphic_factory.TextMenuFactory.LOADING;
...
public class LoadingMenu extends MenuImp {
    ...
    private void getProgress(long now) {
        ...
        loading.setTexture(CreateText.textInLoadingMenuToImage(text, new Color(34, 255, 14)));
        render();
    }
}
