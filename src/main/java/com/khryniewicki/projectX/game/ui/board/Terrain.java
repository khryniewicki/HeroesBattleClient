...
@Data
public class Terrain implements BoardObjects {
    ...
    public Terrain(String name, float obstacle_positionX0, float obstacle_positionY0, float obstacle_positionX1, float obstacle_positionY1) {
    ...
    public Terrain(String name, float obstacle_positionX0, float obstacle_positionY0, float height) {
        width = 0.2f;
        inclination = 0;
        setName(name);
    ...
    public Terrain(String name,float obstacle_positionX0, float obstacle_positionY0, double widthD) {
        height = 0.2f;
        inclination = 0;
        setName(name);
